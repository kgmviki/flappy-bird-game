...
function initAudio() {
    ...
    try {
        ...
        musicGainNode.gain.value = 0.3; // Lower volume for background music
...
function startBackgroundMusic() {
    ...
    const playMelody = () => {
        ...
        const melody = [523, 587, 659, 698, 784, 698, 659, 587]; // C5, D5, E5, F5, G5, F5, E5, D5
        
        melody.forEach((frequency, index) => {
            playMelodyNote(frequency, currentTime + (index * noteDuration), noteDuration * 0.8);
        });
        
        // Schedule next melody loop
        backgroundMusic = setTimeout(playMelody, melody.length * noteDuration * 1000);
    };
